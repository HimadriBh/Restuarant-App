...
export default class Contact extends Component {
    ...
    handleSubmit(event){
        console.log("Currrent State is: " + JSON.stringify(this.state))
        alert("Currrent State is: " + JSON.stringify(this.state))
    ...
    render(){
        const { firstname, lastname, email, telnum, message, contactType, agree } = this.state;  
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="tel" id="telnum" name="telnum"
                                  placeholder="Tel. Number" value={telnum}
                                  valid={errors.telnum === ''}
                        ...
                        <FormGroup row>
                            ...
                            <Col md={{size: 3, offset: 1}}>
                                <Input type="select" name="contactType"
                                    value={contactType} onChange={this.handleInputChange}>
                                        <option>Tel.</option>
                                        <option>Email</option>
                                </Input>
                            </Col>
